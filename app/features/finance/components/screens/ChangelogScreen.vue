...
<style scoped>
.changelog{max-width:720px;margin:auto;display:grid;gap:14px}.changelog__hero,.changelog__release,.changelog__update,.changelog__status{border:2px solid var(--border);background:var(--surface);box-shadow:var(--shadow-sm)}.changelog__hero{display:flex;align-items:center;gap:14px;padding:18px}.changelog__mark{width:44px;height:44px;display:grid;place-items:center;flex:0 0 auto;background:var(--primary);color:var(--bg);font-size:28px;font-weight:900;border:2px solid var(--border)}.changelog__hero-copy{min-width:0;flex:1}.changelog__eyebrow{font-size:10px;font-weight:900;letter-spacing:.12em;color:var(--text3)}h2{font-size:24px;font-weight:900}.changelog__hero p:last-child{font-size:13px;color:var(--text3)}.changelog__check{display:inline-flex;align-items:center;justify-content:center;gap:7px;flex:0 0 auto;min-height:38px;border:2px solid var(--border);background:var(--primary);box-shadow:var(--shadow-sm);color:var(--bg);padding:8px 10px;font:inherit;font-size:12px;font-weight:900;cursor:pointer}.changelog__check:disabled{cursor:wait;opacity:.72}.changelog__release{padding:14px}.changelog__version{display:flex;justify-content:space-between;gap:12px}.changelog__version strong{font-size:16px}.changelog__version span{font-size:12px;color:var(--text3)}ul{margin:10px 0 0;padding-left:18px;display:grid;gap:6px;font-size:13px}.changelog__update{padding:12px;background:var(--primary-dim);display:grid;gap:8px}.changelog__update span,.changelog__status{font-size:13px;color:var(--text2);white-space:pre-line}.changelog__update a{justify-self:start;border:2px solid var(--border);background:var(--surface);box-shadow:var(--shadow-xs);padding:7px 10px;color:var(--text);font-size:12px;font-weight:900;text-decoration:none}.changelog__status{padding:10px}.changelog__status--error{color:var(--danger);border-color:var(--danger)}
