  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@500;600;700&family=Inter:wght@600;700;800&family=Space+Grotesk:wght@400;500;600;700&display=swap' },
